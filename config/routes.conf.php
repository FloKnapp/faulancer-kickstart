...
return [
    ...
    /*
     * This is an example definition of the 'index' route and the supported core options;
     * you may add custom options if needed but please don't change the core options!
     */
    'index' => [
        'path'       => '/',
    ...
    'article' => [
        'path'       => '/article/(\d+)',
        'controller' => \App\Controller\WebsiteController::class,
        'action'     => 'article',      // Note that the term 'Action' is appended through the dispatcher
        'method'     => ['GET'],      // Optional; You can restrict routes to methods. Default is 'GET'
    ]
];